<?php
require_once( 'home/admin/web/zakarpattyafm.com.ua/public_html/wp-load.php' );
require_once 'home/admin/web/zakarpattyafm.com.ua/socket3/src/HemiFrame/Lib/WebSocket.php';
